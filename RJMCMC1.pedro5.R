...
#read in data
arm = read.csv("tiabaya_pedro5_waddlhouses.csv")
...
dataset$uniblock[which(dataset$UNICODE=="1.24.5.44A")]<-"1.24.5.8"
dataset$uniblock[which(dataset$UNICODE=="1.24.5.188A")]<-"1.24.5.23"
dataset$uniblock[which(dataset$UNICODE=="1.24.5.42E")]<-"1.24.5.8"
dataset$uniblock[which(dataset$UNICODE=="1.24.5.42F")]<-"1.24.5.8"
dataset$uniblock[which(dataset$UNICODE=="1.24.5.66A")]<-"1.24.5.12"
...
occult.prob.ids.ordered <- occult.prob.ids[order(occult.prob.new, decreasing = TRUE),]
    if(m%%100000==0) {
      print(m)
    	write.csv(occult.prob.ids.ordered, file=paste("/home/ebillig/Jewell_data/Pedro5/", today, "beta",betastart,"Results.csv", sep=""))
     save.image(paste("/home/ebillig/Jewell_data/Pedro5/", today, "beta",betastart,"Results.Rdata", sep=""))}
# if(m%%100==0){
#   print(m)
#   print(N_I)
#   print(beta[m])
