...
house1.1 = newXMLNode("house1_inspected_house1", parent=house1, attrs=c(address="Calle Franklin 42", risk="High", lat=-10, long=30.2))
house1.2 = newXMLNode("house1_inspected_house2", parent=house1, attrs=c(address="Calle Franklin 5", risk="High", lat=-10, long=30.21))
house1.3 = newXMLNode("house1_inspected_house3", parent=house1, attrs=c(address="Calle Franklin 6", risk="Medium", lat=-10, long=30.21))
