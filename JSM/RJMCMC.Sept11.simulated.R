...
runsimulation <- function(N,truebeta,trueRb){
...
#       tobs[i] <- round(runif(1,min = trueinfectiontime[i], max = maxt))
#       inspected[i]=1
#     }
#   }
#   
...
N_I=which(trueinfectiontime!=Inf)
...
runMCMC <- function(betastart, Rbstart, totaliterations,data, occults, bugs, predprobs, N, truebeta, trueRb, threshold){
